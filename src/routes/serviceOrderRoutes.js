...
// List + create
router.route('/')
    .get(authorize('admin', 'manager', 'operations', 'sales'), getServiceOrders)
    .post(authorize('admin', 'manager', 'sales'), createServiceOrder);

// Single order
router.route('/:id')
    .get(authorize('admin', 'manager', 'operations', 'sales'), getServiceOrder)
...
router.get('/:id/activity', authorize('admin', 'manager', 'operations', 'sales'), getServiceOrderActivity);
